...
public class AccountHolder {
	...
	// Adds a CDAccount to the account holder
		public void addCDAccount(CDOffering offering, double openBalance) {
			...
			cdAccountArray[numCdAccount]=newA;
			numCdAccount++;
		}
		...
		public void addCDAccount(CDAccount cdAccount) {
			cdAccountArray[numCdAccount]= cdAccount;
					numCdAccount++;
		...
		public double getCDBalance() {
			double total = 0.0;
			for (int i=0; i<numCdAccount; i ++) {
				total += cdAccountArray[i].getBalance();
			}
			return total;
		}
